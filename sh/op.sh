...
echo "CONFIG_XFRM=y" >> target/linux/mediatek/filogic/config-6.12
echo "CONFIG_XFRM_ALGO=y" >> target/linux/mediatek/filogic/config-6.12
echo "CONFIG_XFRM_USER=y" >> target/linux/mediatek/filogic/config-6.12
